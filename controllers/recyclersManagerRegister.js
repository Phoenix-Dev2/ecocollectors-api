...
const signUp = async (req, res) => {
  try {
    // Check if the email already exists in recyclers_manager_join_requests
    const checkQuery =
      "SELECT * FROM recyclers_manager_join_requests WHERE email = ?";
    ...
    const insertQuery = `
      INSERT INTO recyclers_manager_join_requests 
