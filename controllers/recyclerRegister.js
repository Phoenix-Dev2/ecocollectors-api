...
const signUp = (req, res) => {
  // Check Existing user
  const q = 'SELECT * FROM recyclers_join_requests WHERE email = ?';
  ...
  db.query(q, [req.body.email], (err, data) => {
    ...
    const insertQuery =
      'INSERT INTO recyclers_join_requests(`join_date`,`first_name`,`last_name`,`email`,`phone`,`message`,`user_id`,`status`) VALUES (?, ?, ?, ?, ?, ?, ?, ?)';
    const values = [
      req.body.join_date,
      req.body.first_name,
      req.body.last_name,
